...
{
    public:
        FaceNetClassifier(Logger gLogger, const string uffFile, const string engineFile, int batchSize,
        ...
        void resetVariables();
        void getE(cv::Mat face, float emb[128]);
        void predictSVM(cv::Mat frame, std::vector<struct Bbox> outputBbox, Ptr<SVM> svm);
    private:
